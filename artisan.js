        ...
        <header class="profile-header container">
            <div class="header-main">
                <div class="profile-picture-container">
                    <img src="${photos.length > 0 ? photos[0] : "placeholder.jpg"}" alt="${artisan.name}">
                </div>
        ...
        <main class="profile-body container">
            <div class="cv-grid">
                <div class="cv-main-column">
                    ...
                    ${artisan.craft_process ? `
                        <section class="card">
                            <h2 class="card-title">${ICONS.star} The Crafting Process</h2>
                            <p>${artisan.craft_process}</p>
                        </section>`
                    : ""}
                        ...
                        <section class="card">
                            ...
                            <div class="gallery-grid">
                                ${photos
                                  .map(
                                    (photo, i) =>
                                      `<div class="gallery-item"><img src="${photo}" alt="Artwork ${i +3}"></div>`
                                  )
                                  .join("")}
                            </div>
                            ${artisan.video_link ? `
                                <div class="video-item">
                                    <iframe src="${artisan.video_link}" allowfullscreen></iframe>
                                </div>`
                            : ""}
                        </section>`
                    : ""}
                ...
                <div class="cv-sidebar-column">
                    ...
                    ${artisan.gi_tag_info || artisan.verification_notes ? `
                        <section class="card">
                            <h2 class="card-title">${ICONS.shield} Authenticity</h2>
                            ${artisan.gi_tag_info ? `<div class="gi-tag">GI Tag: ${artisan.gi_tag_info}</div>` : ""}
                            ${artisan.verification_notes ? `<p class="verification-notes">${artisan.verification_notes}</p>` : ""}
                        </section>`
                    : ""}

                    ${businessIdentity ? `
                        <section class="card">
                            <h2 class="card-title">${ICONS.externalLink} Business Identity</h2>
                            <ul class="business-info">
                                <li><span>Name:</span> <span>${businessIdentity.name}</span></li>
                                <li><span>Type:</span> <span>${businessIdentity.type}</span></li>
                                ${businessIdentity.established ? `<li><span>Established:</span> <span>${businessIdentity.established}</span></li>` : ""}
                            </ul>
                        </section>`
                    : ""}
                </div>
